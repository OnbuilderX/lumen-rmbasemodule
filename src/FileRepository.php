...
use RmBased\Modules\Exceptions\InvalidAssetPath;
use RmBased\Modules\Exceptions\ModuleNotFoundException;
use RmBased\Modules\Process\Installer;
use RmBased\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \RmBased\Modules\Exceptions\ModuleNotFoundException
     */
